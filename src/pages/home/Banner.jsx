...
import banner from "../../assets/shihan1.png";
...
const Banner = () => {
  ...
  return (
    <section className="grid grid-cols-1 md:grid-cols-12 gap-8 items-center sm:pt-10 md:pt-0 ">
      ...
      <div className="my-2 md:my-10 mt-8 sm:mt-16 md:mt-8 lg:mt-24 lg:my-6 col-span-10 lg:col-span-7 text-left">
      ...
      {/* social icons */}
      <div className="hidden lg:block fixed bottom-0 left-0 md:bottom-28 rounded-none border-none z-20">
