  ...
  return (
    <section className="grid grid-cols-1 md:grid-cols-12 gap-8 items-center sm:pt-10 md:pt-0">
      <div className="col-span-12 lg:col-span-5 hidden lg:block">
        <img
          className="h-[100vh] sm:w-3/4 mx-auto md:w-full pt-10 text-center"
          src={banner}
      ...
      <div className="my-2 md:my-10 mt-8 sm:mt-16 md:mt-24 lg:my-6 col-span-10 lg:col-span-7 text-left">
        <h2 className="ml-2 md:ml-20 xl:ml-0 text-2xl font-semibold">
          Hello - I'm
        </h2>
        <h1 className="inline-block text-left text-4xl md:text-7xl font-semibold ml-2 md:ml-20 xl:ml-0 mb-2 bg-gradient-to-r from-[#c0eb4a] to-zinc-950 bg-clip-text text-transparent">
          Mahmudul Hasan Shihan
        </h1>
        <h4 className="ml-2 md:ml-20 xl:ml-0 text-xl mb-3 text-white">
          A MERN Stack Developer.
        </h4>
        <div className="space-x-2 flex justify-center md:block ml-0 md:ml-20 xl:ml-0">
          <a
